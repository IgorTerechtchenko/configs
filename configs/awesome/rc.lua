...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "α" , "β", "γ", "δ", "ε", "web", "media", "org" }, s, layouts[1])
end
-- }}}
...
baticon.image = beautiful.widget_bat
--Initialize widget
batbar = awful.widget.progressbar()
batwidget = wibox.widget.textbox()
--Progressbar properties
batbar:set_vertical(true):set_ticks(true)
batbar:set_height(15):set_width(8):set_ticks_size(2)
...
vicious.register(batbar, vicious.widgets.bat,  "$2", 30, "BAT0")
...
globalkeys = awful.util.table.join(
    ...
    awful.key(
       {}, "Print",
        function()
            awful.util.spawn_with_shell("~/.bin/capscr", false)
        end
    ),
    awful.key({ modkey,           }, "j",
        function ()
...
awful.rules.rules = {
    ...
    -- Set Firefox to always map on tags number 6 of screen 1.
    { rule = { class = "Firefox" },
      properties = { tag = tags[1][6] } },
    { rule = { class = "Rednotebook" },
      properties = { tag = tags[1][8] } },
    { rule = { class = "Taskcoach.py" },
      properties = { tag = tags[1][8] } },
    { rule = { class = "Steam" },
